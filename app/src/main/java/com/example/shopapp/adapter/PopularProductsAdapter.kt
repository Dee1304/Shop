...
class PopularProductsAdapter(private var lst: List<PopularProducts>, var context: Context) : RecyclerView.Adapter<PopularProductsAdapter.PopularProductsViewHolder>() {
    private lateinit var binding: CustomRcvPopularProductsBinding

    inner class PopularProductsViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PopularProductsViewHolder {
        ...
        return PopularProductsViewHolder(binding.root)
    }
